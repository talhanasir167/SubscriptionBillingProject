...
__webpack_require__(/*! channels */ "./app/javascript/channels/index.js"); //= require activestorage
//= require_tree
//= require jquery
//= require jquery_ujs
//= require jquery3
...
window.addEventListener("load", function () {
  var element = document.querySelector(".new-form");
  element.addEventListener("ajax:success", function (event) {
    var _event$detail3 = _slicedToArray(event.detail, 3),
        _data = _event$detail3[0],
        _status = _event$detail3[1],
        xhr = _event$detail3[2];
...
/******/ });
//# sourceMappingURL=application-41ea7fa611fc74793402.js.map