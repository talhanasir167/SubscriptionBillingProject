...
window.addEventListener("load", function () {
  var element = document.querySelector(".new-article");
...
addEventListener("direct-upload:progress", function (event) {
  var _event$detail2 = event.detail,
      ...
      progress = _event$detail2.progress;
...
addEventListener("direct-upload:error", function (event) {
  ...
  var _event$detail3 = event.detail,
      id = _event$detail3.id,
      error = _event$detail3.error;
  var element = document.getElementById("direct-upload-".concat(id));
...
/******/ });
//# sourceMappingURL=application-f7decc5920a0636cdc02.js.map